            ...
            userReservations.data.map((reservation: any) => {
              return <div key={reservation.id} className="bg-tertiary py-8 px-12">
                <div className="flex flex-col gap-4 lg:flex-row items-center justify-between ">
                  <h3 className="text-2xl font-medium w-[300px] text-center">{reservation.room.title}</h3>
                  ...
                  <div className="flex flex-col lg:flex-row lg:w-[380px] gap-2">
                    ...
                    <div className="flex items-center gap-1 flex-1">
                      ...
                      <span className="text-secondary font-semibold">{format(reservation.checkin,'PPP')}</span>
                    </div>
                    {/* ............check out.......... */}
                    <div className="flex items-center gap-1 flex-1">
                      <span className="text-accent font-bold uppercase tracking-[2px]">to:</span>
                      <span className="text-secondary font-semibold">{format(reservation.checkout,'PPP')}</span>
                    </div>
                  </div>
